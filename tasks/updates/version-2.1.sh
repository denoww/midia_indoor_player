...
sh -c 'cp /var/lib/sc_player/device_configs/wallpaper.png /var/lib/Pictures/wallpaper.png'
...
sh -c 'sudo cp /var/lib/sc_player/device_configs/splash.png /usr/share/plymouth/themes/pix/splash.png'
